...
$b = $obj -> eliminar ($_POST);
    if($_SESSION['roles'] == "Administrador"){
        if ($b === 1){
            echo '<script language="javascript">alert("Se elimino la cita");window.location="../VISTAS/INTERFACES/administrador/home.php"</script>';
        }
    ...
    if($_SESSION['roles'] == "Cliente"){
        if ($b === 1){
            echo '<script language="javascript">alert("Se elimino la cita");window.location="../VISTAS/INTERFACES/cliente/home.php"</script>';
        }
        else if(str_contains($b,'SQLSTATE[HY000] [2002]')){ 
    ...
    if($_SESSION['roles'] == "Auxiliar_Odontologia"){
        if ($b === 1){
            echo '<script language="javascript">alert("Se elimino la cita");window.location="../VISTAS/INTERFACES/auxiliar/home.php"</script>';
        }
        else if(str_contains($b,'SQLSTATE[HY000] [2002]')){ 
    ...
    if($_SESSION['roles'] == "Odontologo"){
        if ($b === 1){
            echo '<script language="javascript">alert("Se elimino la cita");window.location="../VISTAS/INTERFACES/odontologo/home.php"</script>';
        }
        else if(str_contains($b,'SQLSTATE[HY000] [2002]')){ 
