...
?>
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR CITAS
                </h3>
                <p class="text-justify">
                    Aca podras consultar tus citas
                </p>
            </div>
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    ...
                    <li>
                        <a class="active" href="cita-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR CITA</a>
                    </li>
                </ul>
            </div>
        ...
        data:parametros,
        type: 'POST',
        url: '../../../CONTROLADORES/Consulta_esp_citas.php',
