...
<?php 
	...
	Agenda on Agenda.NumeroDoc = usuario.NumeroDoc and agenda.NumeroDoc = $num_doc_session and Agenda.Estado = 0")->fetchall();
?>
            <!-- Page header -->
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    ...
                    <li>
                        <a class="active" href="agenda-eliminated.php"><i class="fas fa-ban fa-fw"></i> &nbsp; AGENDAS ELIMINADAS</a>
                    </li>
                    <li>
